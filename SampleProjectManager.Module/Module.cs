...
public sealed class SampleProjectManagerModule : ModuleBase {
    public SampleProjectManagerModule() {
        ...
        AdditionalExportedTypes.Add(typeof(DevExpress.Persistent.BaseImpl.Person));
        AdditionalExportedTypes.Add(typeof(DevExpress.Persistent.BaseImpl.Organization));
